...
*/
#ifndef _ANCH_DATE_FORMATTER_MINUTE_FORMATTER_H_
#define _ANCH_DATE_FORMATTER_MINUTE_FORMATTER_H_
...
namespace anch {
  namespace date {
    namespace formatter {
      ...
      /**
       * Minutes formatter part
       *
       * @author Vincent Lachenal
       */
      class MinuteFormatter: public IDatePartFormatter {
      public:
	/** The pattern */
	static const std::string PATTERN;
      ...
      public:
	/**
	 * {@link MinuteFormatter} default constructor
	 */
	MinuteFormatter();

	/**
	 * {@link MinuteFormatter} destructor
	 */
	virtual ~MinuteFormatter();
	...
	/**
	 * Return a new instance of {@link MinuteFormatter}
	 *
	 * @return A new instance of {@link MinuteFormatter}
	 */
...
#endif // _ANCH_DATE_FORMATTER_MINUTE_FORMATTER_H_
