...
*/
#ifndef _ANCH_DATE_FORMATTER_DAY_FORMATTER_H_
#define _ANCH_DATE_FORMATTER_DAY_FORMATTER_H_
...
namespace anch {
  namespace date {
    namespace formatter {
       ...
       */
      class DayFormatter: public IDatePartFormatter {
      public:
	/** The pattern */
...
#endif // _ANCH_DATE_FORMATTER_DAY_FORMATTER_H_
