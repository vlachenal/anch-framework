...
*/
#ifndef _ANCH_DATE_FORMATTER_MILLISECOND_FORMATTER_H_
#define _ANCH_DATE_FORMATTER_MILLISECOND_FORMATTER_H_
...
namespace anch {
  namespace date {
    namespace formatter {
       ...
       */
      class MillisecondFormatter: public IDatePartFormatter {
      public:
	/** The pattern */
...
#endif // _ANCH_DATE_FORMATTER_MILLISECOND_FORMATTER_H_
