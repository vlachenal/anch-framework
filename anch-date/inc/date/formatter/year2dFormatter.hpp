...
*/
#ifndef _ANCH_DATE_FORMATTER_YEAR_2D_FORMATTER_H_
#define _ANCH_DATE_FORMATTER_YEAR_2D_FORMATTER_H_
...
namespace anch {
  namespace date {
    namespace formatter {
       ...
       */
      class Year2DFormatter: public IDatePartFormatter {
      public:
	/** The pattern */
...
#endif // _ANCH_DATE_FORMATTER_YEAR_2D_FORMATTER_H_
