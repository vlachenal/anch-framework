...
main(int argc, char** argv) {
  ...
  if(all || (strcmp("ISO7816_4", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.ISO7816_4.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.ISO7816_4.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ISO7816_4", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.ISO7816_4.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.ISO7816_4.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("PKCS#7", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.pkcs5.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.pkcs5.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("PKCS#7", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.pkcs5.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.pkcs5.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("zero", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.zero.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.zero.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("zero", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.zero.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.zero.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ANSIX923", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.ANSIX923.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.ANSIX923.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ANSIX923", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("192", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes192.ANSIX923.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes192.ANSIX923.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ISO7816_4", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.ISO7816_4.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.ISO7816_4.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ISO7816_4", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.ISO7816_4.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.ISO7816_4.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("PKCS#7", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.pkcs5.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.pkcs5.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("PKCS#7", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.pkcs5.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.pkcs5.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("zero", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.zero.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.zero.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("zero", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.zero.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.zero.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ANSIX923", argv[1]) == 0 && strcmp("sequential", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.ANSIX923.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.ANSIX923.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
  ...
  if(all || (strcmp("ANSIX923", argv[1]) == 0 && strcmp("parallel", argv[2]) == 0 && strcmp("256", argv[3]) == 0)) {
    ...
    std::cout << "Compute Makefile.cbc.aes256.ANSIX923.async.decipher hash using SHA1" << std::endl;
    input = new std::ifstream("Makefile.cbc.aes256.ANSIX923.async.decipher", std::ifstream::binary);
    SHA1 cipherHash(*input);
    std::array<uint8_t,20> resHash = cipherHash.digest();
    input->close();
    delete input;
