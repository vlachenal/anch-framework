...
anch::ut::setup(anch::ut::UnitTests& tests) {
  tests
    .name("AnCH SHA1 unit tests")
    .description("Test AnCH SHA1 library")
    .add("sha1-abc", testABC)
    .add("sha1-plop", testPlop)
    .add("sha1-1Ma", testMillionA)
    .add("sha1-sec-password", testSecPasswd)
    ;
}
