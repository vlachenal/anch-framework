...
namespace anch {
  namespace json {
    ...
    void
    discardChars(std::istream& input, const anch::json::MappingOptions& options) {
      int discarded = 0;
    ...
    bool
    isNull(std::istream& input, const anch::json::MappingOptions& options) {
    ...
    getFieldName(std::istream& input, const anch::json::MappingOptions& options) {
      anch::json::discardChars(input, options);
    ...
    bool
    hasMoreField(std::istream& input, const anch::json::MappingOptions& options) {
      anch::json::discardChars(input, options);
